...
departure_path = f"s3://team5-s3/raw_data/flight_operations/flight_operations_출발_{target_date}.parquet"
arrival_path = f"s3://team5-s3/raw_data/flight_operations/flight_operations_도착_{target_date}.parquet"
target_path = f"s3://team5-s3/transform_data/flight_operations/{target_date}/"
